---
layout: post
title:  "Mastering Graphs : Dijkstra's Shortest Path Algorithm"
...
Given a weighted graph, we want to find out the the shortest path/distance from a source node to all other nodes in the graph. See Tutorial for explanation.

#### **Complexity**: 
`O(ELogV)`

#### **Data Structures Used**:
List, Pair, Set, Hashmaps



**Code**

[Try in CB IDE](https://codingblocks.com/ide/#/s/3059)
